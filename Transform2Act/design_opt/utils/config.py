...
class Config:
    ...
    def __init__(self, cfg_id, tmp, cfg_dict=None, ctrl_only=False, xml_path=None, max_epoch_num=None):
        self.id = cfg_id
        ...
        # create dirs
        base_dir = '/tmp/design_opt' if tmp else 'results_init'
        ...
        self.ctrl_only = cfg.get('ctrl_only', False) or ctrl_only
