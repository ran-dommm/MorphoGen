...
TARGET_SCORE=""
LOG_LEVEL="INFO"
OUTPUT_DIR="./openevolve/examples/design_opt_rl_gap/result/gap_new"
EXTRACT_TOP=""
...
export OPENEVOLVE_ROBOT_XML="./openevolve/examples/design_opt_rl_gap/init_xml/best.xml"

# Build command arguments
CMD_ARGS=(
    "./openevolve/examples/design_opt_rl_gap/init_xml/best.xml"
    "./openevolve/examples/design_opt_rl_gap/evaluator.py"
    "--config" "./openevolve/examples/design_opt_rl_gap/config.yaml"
    "--log-level" "$LOG_LEVEL"
    "--output" "$OUTPUT_DIR"
)
...
if [ -n "$EXTRACT_TOP" ]; then
    ...
    if [ -d "$OUTPUT_DIR/checkpoints" ]; then
        ...
        if [ -n "$LATEST_CHECKPOINT" ]; then
            ...
            python ./openevolve/examples/design_opt_rl_gap/extract_top_programs.py \
                "$CHECKPOINT_PATH" \
                --config "./openevolve/examples/design_opt_rl_gap/config.yaml" \
