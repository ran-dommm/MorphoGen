...
def main():
    ...
    checkpoint_path = os.path.join(f"./openevolve/examples/design_opt_rl_{args.env}/init_xml/{args.env}_{args.model}/checkpoints", f"checkpoint_{args.iteration}")
    output_path = os.path.join(f"./openevolve/examples/design_opt_rl_{args.env}/init_xml/{args.env}_{args.model}/top_programs")
