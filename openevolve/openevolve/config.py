...
@dataclass
class EliteSeedsConfig:
    """Configuration for elite seeds"""
...
class Config:
    ...
    elite_seeds: EliteSeedsConfig = field(default_factory=EliteSeedsConfig)
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> "Config":
        ...
        if "elite_seeds" in config_dict:
            config.elite_seeds = EliteSeedsConfig(**config_dict["elite_seeds"])
        return config
